...
export const TablePacks = () => {
  ...
  const openTablePackHandler = (cardsPack_id: string, packName: string, user_id: string) => {
    navigate(`/packs/${cardsPack_id}/${packName}/${user_id}`)
  }
            ...
            return (
              ...
              >
                <TableCell
                  ...
                  component="th"
                  scope="row"
                  onClick={() => openTablePackHandler(d._id, d.name, d.user_id)}
                >
                  {d.name}
                </TableCell>
